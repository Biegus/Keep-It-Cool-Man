...
namespace Toolbox.Editor
{
    ...
    internal static partial class InspectorUtility
    {
        static InspectorUtility()
        {
            ...
            DisabledToolboxEditor.OnBeginToolboxEditor += (editor) =>
            {
                CurrentTargetObjects = editor.targets;
            };
            DisabledToolboxEditor.OnCloseToolboxEditor += (editor) =>
            {
        ...
        /// <summary>
        /// Event fired every time when <see cref="DisabledToolboxEditor"/>s were re-created.
        /// </summary>
        internal static event Action OnEditorReload;


        /// <summary>
        /// Last cached targetObjects from the currently processed <see cref="DisabledToolboxEditor"/>.
        /// </summary>
