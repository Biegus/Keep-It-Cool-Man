...
namespace NaughtyAttributes.Editor
{
	...
	public class NaughtyInspector : UnityEditor.Editor
	{
		...
		protected IEnumerable<FieldInfo> _nonSerializedFields;
		protected IEnumerable<PropertyInfo> _nativeProperties;
		...
		public override void OnInspectorGUI()
		{
			...
			if (!anyNaughtyAttribute)
			{
				...
				{
					if (ex.Message != "SerializedObject of SerializedProperty has been Disposed.")
						throw;
				}
